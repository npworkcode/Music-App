...
public class NowPlayingActivity extends AppCompatActivity
{
    ...
    private void initializeUI(Artist artist, Album album, Song song)
    {
        ...
        TextView songLengthTextView = findViewById(R.id.now_playing_song_tracklength);
        songLengthTextView.setText(song.getmTrackLength().toString());
        TextViewCompat.setTextAppearance(songTextView, R.style.SongStyle);
        songTextView.setBackgroundResource(R.color.songBGOneColor);
        TextViewCompat.setTextAppearance(songLengthTextView, R.style.SongStyle);
        songLengthTextView.setBackgroundResource(R.color.songBGOneColor);
    }
